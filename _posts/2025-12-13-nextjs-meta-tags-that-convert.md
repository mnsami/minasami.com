...
My pages were finally indexed ([robots.txt fixed]({{ site.baseurl }}{% post_url 2025-12-05-nextjs-seo-robots-txt-mistake %})) and discoverable ([sitemap submitted]({{ site.baseurl }}{% post_url 2025-12-12-nextjs-dynamic-multilingual-sitemaps %})). I was ranking positions 8-15 for dozens of keywords.
